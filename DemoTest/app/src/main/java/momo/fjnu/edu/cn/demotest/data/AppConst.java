...
public class AppConst {
    /**数据库名称*/
    public static final String DB_NAME = "demotest.db";
    /**数据库存储目录*/
    public static final String DB_DIRECTORY = Environment.getExternalStorageDirectory() + "/momo/fjnu.edu.cn.demotest/db";
    /**数据库版本号*/
